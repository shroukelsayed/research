...
class CreateCaseRoommatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('case_roommates', function (Blueprint $table) {
            ...
            $table->text('relativity')->nullable();
    ...
    {
        Schema::dropIfExists('case_roommates');
    }
}

...
<div id="content" class="padding-20">
  ...
  {!! Form::open(['url'=> url('cases') , 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
...
<!-- Stacked Left -->
  <div id="panel-ui-tan-l2" class="panel panel-default">
    ...
    <div class="panel-heading">
      ...
      <span class="elipsis"><!-- panel title -->
          <strong>إضافة الاستمارة الجديدة</strong>
      </span>
      ...
      <div class="row tabs nomargin">
        ...
        <div class="col-md-9 col-sm-9 nopadding-right nopadding-left">
          <div class="tab-content">
            ...
            @include('partials.case.create.tab_1')
            @include('partials.case.create.tab_2')
            @include('partials.case.create.tab_3')
            @include('partials.case.create.tab_4')
            @include('partials.case.create.tab_5')
            @include('partials.case.create.tab_6')
            @include('partials.case.create.tab_7')
            @include('partials.case.create.tab_8')
            @include('partials.case.create.tab_9')
            @include('partials.case.create.tab_10')
            @include('partials.case.create.tab_11')
            @include('partials.case.create.tab_12')
  ...
  <input name="case_typer_id" type="hidden" value="{{Auth::id()}}">
  <input name="access_code" type="hidden" value="Y5LbAN9ei6pgovLybld6Qmslrskm8h0eg6ErA7kYAFA">

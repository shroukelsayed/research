    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('case_need_project', ['نعم' => 'نعم', 'لا' => 'لا'], $case->case_need_project, array('class' => 'form-control select2', 'style' => 'width:100%','onchange' => 'if($(this).val()=="0"){$("#project").hide();}else{$("#project").show();}')) !!}
            </div>
        </div>
    </div>

    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('case_city', ['أدفو' => 'أدفو', 'اطسا' => 'اطسا', 'الصف' => 'الصف', 'بني سويف' => 'بني سويف', 'نصر النوبة' => 'نصر النوبة', 'اطا' => 'اطا', 'اهنسيا' => 'اهنسيا', 'سمسطا' => 'سمسطا', 'قنا' => 'قنا', 'يوسف الصديق' => 'يوسف الصديق'], $case->city, array('placeholder' => 'لا شيء' , 'class' => 'form-control select2')) !!}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('case_district', ['الشودك' => 'الشودك',
                  ...
                  'كساب' => 'كساب',
                  'ميانه' => 'ميانه'], $case->district, array('placeholder' => 'لا شيء' , 'class' => 'form-control select2')) !!}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">

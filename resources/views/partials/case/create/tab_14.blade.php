    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('case_need_project', ['نعم' => 'نعم', 'لا' => 'لا'], old('case_need_project') or null, array('placeholder' => 'لا شيء' , 'class' => 'form-control select2', 'style' => 'width:100%','onchange' => 'if($(this).val()!="0"){$("#project").show();}else{$("#project").hide();}')) !!}
            </div>
        </div>
    </div>
